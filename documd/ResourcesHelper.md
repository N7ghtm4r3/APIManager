...
public class ResourcesDemo {
    ...
    public static void main(String[] args) throws IOException {
        // create a File from a stream of a file in the "resources" folder
        File resource = ResourcesHelper.getResourceFromStream(ResourcesDemo.class, "nameOfTheResource.itsSuffix"); 
    }
