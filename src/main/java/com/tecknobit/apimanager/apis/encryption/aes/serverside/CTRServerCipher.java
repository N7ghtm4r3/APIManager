...
import static com.tecknobit.apimanager.apis.encryption.aes.AESClientCipher.Algorithm.CTR_ALGORITHM;
 ...
 * @since 2.0.2
 */
public class CTRServerCipher extends AESGenericServerCipher {
     ...
     */
    public static SecretKey createCTRSecretKey(AESKeySize keySize) throws NoSuchAlgorithmException {
     ...
     */
    public static String createCTRSecretKeyString(AESKeySize keySize) throws NoSuchAlgorithmException {
