...
import static com.tecknobit.apimanager.apis.encryption.aes.AESClientCipher.Algorithm.CBC_ALGORITHM;
 ...
 * @since 2.0.2
 */
public class CBCServerCipher extends AESGenericServerCipher {
     ...
     */
    public static SecretKey createCBCSecretKey(AESKeySize keySize) throws NoSuchAlgorithmException {
     ...
     */
    public static String createCBCSecretKeyString(AESKeySize keySize) throws NoSuchAlgorithmException {
