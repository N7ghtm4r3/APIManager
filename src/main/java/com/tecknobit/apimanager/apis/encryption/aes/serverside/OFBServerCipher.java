...
public class OFBServerCipher extends GenericServerCipher {
     ...
     **/
    public OFBServerCipher(IvParameterSpec ivParameterSpec, SecretKey secretKey, int keySize) throws
     ...
     * @param keySize:         size in bits for {@link #secretKey}
     **/
    public OFBServerCipher(String ivParameterSpec, String secretKey, int keySize) throws NoSuchPaddingException,
     ...
     **/
    public static SecretKey createOFBSecretKey(int keySize) throws KeySizeException, NoSuchAlgorithmException {
     ...
     * @implNote sizes admitted are {@link #MINIMUM_KEY_SIZE}, {@link #MEDIUM_KEY_SIZE} or {@link #MAXIMUM_KEY_SIZE}
     **/
    public static String createOFBSecretKeyString(int keySize) throws KeySizeException, NoSuchAlgorithmException {
